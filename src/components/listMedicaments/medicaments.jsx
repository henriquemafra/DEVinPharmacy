export const medicamentosExemplos = [
    {
      "nomeMedicamento": "Aspirina",
      "laboratorio": "Bayer",
      "dosagem": "500mg",
      "descricaoBreve": "Analgésico e antipirético amplamente utilizado para alívio de dores leves a moderadas e redução de febre.",
    ...
    },
    {
      ...
      "laboratorio": "Pfizer",
      "dosagem": "500mg",
      "descricaoBreve": "Analgésico e antipirético comum para alívio de dores leves a moderadas e diminuição da temperatura corporal.",
    ...
    },
    {
      ...
      "laboratorio": "Pfizer",
      "dosagem": "400mg",
      "descricaoBreve": "Anti-inflamatório não esteroidal utilizado para aliviar dores leves a moderadas, febre e inflamação.",
    ...
    },
    {
      ...
      "laboratorio": "Medley",
      "dosagem": "850mg",
      "descricaoBreve": "Antidiabético oral que controla os níveis de açúcar no sangue, melhorando a sensibilidade à insulina.",
    ...
    },
    {
      ...
      "laboratorio": "Medley",
      "dosagem": "10mg",
      "descricaoBreve": "Inibidor da enzima conversora de angiotensina (IECA) para tratar hipertensão e melhorar a função cardíaca.",
    ...
    },
    {
      ...
      "laboratorio": "Medley",
      "dosagem": "20mg",
      "descricaoBreve": "Estatina que reduz o colesterol, prevenindo doenças cardiovasculares em pessoas com alto risco.",
    ...
    },
    {
      ...
      "laboratorio": "EMS",
      "dosagem": "20mg",
      "descricaoBreve": "Inibidor da bomba de prótons (IBP) usado para reduzir a produção de ácido estomacal e tratar úlceras.",
    ...
    },
    {
      ...
      "laboratorio": "EMS",
      "dosagem": "10mg",
      "descricaoBreve": "Analgésico opioide poderoso para alívio de dores intensas, usado com precaução devido ao risco de dependência.",
    ...
    },
    {
      ...
      "laboratorio": "EMS",
      "dosagem": "100UI/mL",
      "descricaoBreve": "Hormônio essencial para controlar a glicose no sangue, tratando diabetes tipo 1 e tipo 2.",
